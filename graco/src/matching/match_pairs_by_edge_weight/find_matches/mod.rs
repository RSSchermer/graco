...
pub struct FindMatchesResources<'a> {
    ...
    pub nodes_proposal: Storage<'a, [u32]>,
}

type ResourcesLayout = <FindMatchesResources<'static> as empa::resource_binding::Resources>::Layout;
