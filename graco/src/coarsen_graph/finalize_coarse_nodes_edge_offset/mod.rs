...
pub struct FinalizeCoarseNodesEdgeOffsetResources {
    ...
    pub coarse_nodes_edge_offset: Storage<[u32]>,
}

type ResourcesLayout =
    <FinalizeCoarseNodesEdgeOffsetResources as empa::resource_binding::Resources>::Layout;
