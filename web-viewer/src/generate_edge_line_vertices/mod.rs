...
pub struct GenerateEdgeLineVerticesInput<'a, U0, U1, U2, U3, U4> {
    pub nodes_edge_offset: buffer::View<'a, [u32], U0>,
    pub nodes_edges: buffer::View<'a, [u32], U1>,
    pub nodes_position: buffer::View<'a, [abi::Vec2<f32>], U2>,
    pub nodes_matching: buffer::View<'a, [u32], U3>,
    pub edge_vertices: buffer::View<'a, [EdgeVertex], U4>,
}
...
impl GenerateEdgeLineVertices {
    ...
    pub fn encode<U0, U1, U2, U3, U4>(
        ...
        input: GenerateEdgeLineVerticesInput<U0, U1, U2, U3, U4>,
    ) -> CommandEncoder
    where
